...
module.exports = {
  ...
  db: {
    name: process.env.DB_NAME || "smart-sign",
    host: process.env.DB_HOST || "160.153.75.160",
    port: process.env.DB_PORT || 3306,
    username: process.env.DB_USERNAME || "bmcneely",
    password: process.env.DB_PASSWORD || "2little2L8*",
